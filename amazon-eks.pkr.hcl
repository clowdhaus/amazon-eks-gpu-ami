...
source "amazon-ebs" "this" {
  ...
  dynamic "ami_block_device_mappings" {
    ...
    content {
      delete_on_termination = try(ami_block_device_mappings.value.delete_on_termination, null)
      ...
      volume_type           = try(ami_block_device_mappings.value.volume_type, null)
  ...
  dynamic "launch_block_device_mappings" {
    ...
    content {
      delete_on_termination = try(launch_block_device_mappings.value.delete_on_termination, null)
      ...
      volume_type           = try(launch_block_device_mappings.value.volume_type, null)
    }
  }
